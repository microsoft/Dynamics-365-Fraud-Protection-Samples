...
1. **Client application ID**: Your Dynamics 365 Fraud Protection client application's ID in Azure Active Directory (Azure AD). Ensure you have assigned the proper role(s) to your Azure AD client application. Please see the [role documentation](NEED A LINK) for the latest role names and descriptions.
